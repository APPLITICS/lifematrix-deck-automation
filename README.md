...
This approach ensures flexibility, minimizes dependencies, and supports fast slide generation — ideal for both large-scale deck creation and real-time event use.
