...
- The instructions of the pipeline save a structured `.xlsx` grouped by sheet, 1 sheet for each slide. Each sheet includes data to display for the slide in question.
- The slide is built using the generation function and the saved data.
- That Data could be used later for manual value edit.
...
Below is the list of these chart types, along with the corresponding function name and examples of slide numbers where they are used in the example deck:
